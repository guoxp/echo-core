Name "gecho ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/echochain/echo-core/issues"
!define UPDATEURL "https://github.com/echochain/echo-core/releases"
!define ABOUTURL "https://github.com/echochain/echo-core#ethereum-go"
...
# Install gecho binary
Section "Gecho" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gecho}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gecho.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gecho.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gecho incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gecho outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gecho UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gecho incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gecho.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gecho outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gecho.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gecho UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gecho.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gecho.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gecho.ipc"
