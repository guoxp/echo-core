...
# 1. install gecho for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gecho
# 5. create gecho, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gecho is installed global
