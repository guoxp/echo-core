...
// gecho is the official command-line client for Ethereum.
package main
...
const (
	clientIdentifier = "gecho" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the gecho command line interface")
...
func init() {
	// Initialize the CLI app and start Gecho
	app.Action = gecho
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2016-2018 The echochain Authors"
...
// gecho is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gecho(ctx *cli.Context) error {
