...
// NodeConfig represents the collection of configuration values to fine tune the Gecho
...
// Node represents a Gecho Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gecho node.
