...
//
// https://github.com/echochain/echo-core/wiki/Management-APIs#personal_sign
...
//
// https://github.com/echochain/echo-core/wiki/Management-APIs#personal_ecRecover
func (api *SignerAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid E signature (V is not 27 or 28)")
	}
