...
import (
	...
	"github.com/echochain/echo-core/internal/jsre"
	"github.com/echochain/echo-core/internal/web3ext"
...
// Welcome show summary of current Gecho instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gecho metadata
	fmt.Fprintf(c.printer, "Welcome to the Gecho JavaScript console!\n\n")
	c.jsre.Run(`
